\name{PCA.centers.SDA}
\alias{PCA.centers.SDA}
\title{principal component analysis for symbolic objects described by symbolic interavl variables. \emph{Centers} algorithm}
\description{principal component analysis for symbolic objects described by symbolic interavl variables. \emph{Centers} algorithm}
\usage{
