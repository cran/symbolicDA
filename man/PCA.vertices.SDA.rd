\name{PCA.vertices.SDA}
\alias{PCA.vertices.SDA}
\title{principal component analysis for symbolic objects described by symbolic interavl variables. \emph{Vertices} algorithm}
\description{principal component analysis for symbolic objects described by symbolic interavl variables. \emph{Vertices} algorithm}
\usage{
