\name{PCA.mrpca.SDA}
\alias{PCA.mrpca.SDA}
\title{principal component analysis for symbolic objects described by symbolic interavl variables. \emph{Midpoints and radii} algorithm}
\description{principal component analysis for symbolic objects described by symbolic interavl variables. \emph{Midpoints and radii} algorithm}
\usage{
