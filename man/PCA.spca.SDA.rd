\name{PCA.spca.SDA}
\alias{PCA.spca.SDA}
\title{principal component analysis for symbolic objects described by symbolic interavl variables. \emph{'Symbolic' PCA} algorithm}
\description{principal component analysis for symbolic objects described by symbolic interavl variables. \emph{'Symbolic' PCA} algorithm}
\usage{
