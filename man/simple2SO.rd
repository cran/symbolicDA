\name{simple2SO}
\alias{simple2SO}
\title{Change of representation of symbolic data from simple form to symbolic data table}
\description{Change of representation of symbolic data from simple form to symbolic data table}
\usage{
simple2SO(x)
}
\arguments{
